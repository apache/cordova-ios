...
@implementation OneAppCDVInvokedUrlCommand
...
+ (OneAppCDVInvokedUrlCommand*)commandFromJson:(NSArray*)jsonEntry
{
    return [[OneAppCDVInvokedUrlCommand alloc] initFromJson:jsonEntry];
}
