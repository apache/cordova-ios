...
{
    CDVWebViewPermissionGrantType result = CDVWebViewPermissionGrantType_Grant;
    ...
    if (optionString != nil){
        if ([optionString isEqualToString:@"prompt"]) {
            ...
            NSLog(@"Invalid \"MediaPermissionGrantType\" was detected. Fallback to default value of \"grant\"");
        }
    }
