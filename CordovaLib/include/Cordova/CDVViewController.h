...
/**
 ...
 guide](https://cordova.apache.org/docs/en/dev/config_ref/index.html) exists.
 The web content displayed within the view has access to Cordova plugins via
 their exposed JavaScript APIs.

 > Important: In accordance with [App Store review
 > guidelines](https://developer.apple.com/app-store/review/guidelines/), you
 > must not expose Apple APIs to web content that is not bundled within the
 > app.
 */
...
/**
 ...
 web view.
 */
@property (nonatomic, nonnull, readonly, strong) id <CDVWebViewEngineProtocol> webViewEngine;
...
/**
 ...
 This can be set in the storyboard file as a view controller attribute.
  */
@property (nonatomic) IBInspectable BOOL showSplashScreen;
