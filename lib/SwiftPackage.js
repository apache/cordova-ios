...
`;
    ...
    addPlugin (plugin, opts = {}) {
        ...
        if (opts.link) {
            ...
            // Replace plugin variables with their actual values
            for (const [varName, varValue] of Object.entries(opts.variables ?? {})) {
                packageContent = packageContent.replaceAll(`$${varName}`, varValue);
            }
