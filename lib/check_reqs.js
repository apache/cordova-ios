 ...
 */
function check_cocoapods (toolChecker) {
 ...
 */
function checkTool (tool, minVersion, message = '', toolFriendlyName = tool) {
 ...
 */
class Requirement {
    constructor (id, name, isFatal = false) {
        this.id = id;
        this.name = name;
