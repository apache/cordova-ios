...
function Podfile(podFilePath, projectName, minDeploymentTraget) {
    this.podToken = '##INSERT_POD##';

    this.path = podFilePath;
    this.projectName = projectName;
    this.minDeploymentTraget = minDeploymentTraget || '8.0';
    this.contents = null;
    this.pods = null;
    this.__dirty = false;
...
Podfile.prototype.getTemplate = function() {
    return util.format(
            ...
            '%s\n' +
            'end\n',
             this.minDeploymentTraget, this.projectName, this.projectName, this.podToken);
};
